  ...
  return (
    <div className="flex-col gap-4 m-10 ">
      ...
      <div className="flex-col gap-4">
        <h1 className="text-5xl font-[650] my-4 ">Build Your Ideal <br /><span className="bg-linear-to-r brand-gradient bg-clip-text text-transparent">Development Stack</span></h1>
      ...
      <div className="flex gap-8">
        <button className="bg-linear-to-r brand-gradient text-white px-3 py-2 rounded-xl">Explore Tecnologies</button>
...
// from - orange - 600 to - fuchsia - 600